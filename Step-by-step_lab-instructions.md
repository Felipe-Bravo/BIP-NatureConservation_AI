...
1. Go to https://earthexplorer.uges.gov and login in the web (if necessary create a new user) Once loged search for your area of interest (in our case Norhern Spain) 
